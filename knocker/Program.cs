...
//string[] mysql = ["-i", "data/User.csv", "data/Route.csv", "data/Bus.csv", "data/Trip.csv", "data/Seat.csv", "data/Ticket.csv", "-d", ",", "-e", "__EFMigrationsHistory", "-p", "mysql", "-c", "Server=127.0.0.1;Database=Etdb;User Id=root;Password=12345678aA#;Allow User Variables=true"];
