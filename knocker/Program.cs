...
string[] sqlserver = ["reset", "-i", "./data", "-d", ",", "-e", "__EFMigrationsHistory", "-c", "Data Source=127.0.0.1;TrustServerCertificate=True;Initial Catalog=Etdb;User ID=sa;Password=12345678aA#"];
...
Parser.Default.ParseArguments<ResetDbOption, DeleteDbOption>(sqlserver)
